...
export default class Bloglist extends React.Component {
    ...
    getbloglistimages = () => {
        ...
        fetch(BASE_URL + "posts/posts?type=post&limit=4&page=1", requestOptions)
            ...
            .then(result => {
                ...
                if (result.success == true) {
                    for (let i = 0; i < result.data.records.length; i++) {
                        ...
                        this.state.listofblogimages.push(result.data.records[i])
                    }
    ...
    renderblogimage = () => {
        return this.state.listofblogimages.map((item) => {
            return (
                <View style={styles.blogview}>
                    <TouchableWithoutFeedback
                        onPress={() => this.props.navigation.navigate('Blogdetailimage')}
                    >
        ...
        return (
                ...
                /> */}
                                ...
                                <View>
                                    {this.renderblogimage()}
                                </View>

                                <View style={styles.blogview}>
                                    <TouchableWithoutFeedback
                                        onPress={() => this.props.navigation.navigate('Blogdetailvideo')}
                                    >
                                        <View style={styles.imageview}>
                                            <YoutubePlayer
                                                height={155}
